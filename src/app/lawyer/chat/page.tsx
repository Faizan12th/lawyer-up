        ...
        <div className="min-h-screen bg-gray-50/50 pb-8">
            ...
            <div className="px-6 py-6 space-y-6">
                <div className="flex items-center gap-2 mb-2">
                    <Link href="/lawyer/dashboard" className="text-muted-foreground hover:text-foreground">
                        <ArrowLeft className="h-4 w-4" />
                    </Link>
                    <h2 className="text-xl font-semibold">Messages</h2>
                </div>
                <p className="text-sm text-muted-foreground -mt-4 mb-6 ml-6">Communicate with your clients</p>

                <div className="grid gap-6 lg:grid-cols-3 h-[600px]">
                    {/* Chat History Sidebar */}
                    <Card className="p-4 lg:col-span-1 overflow-y-auto">
                        <h3 className="font-semibold mb-4 px-2">Recent Chats</h3>
                        {loadingChats ? (
